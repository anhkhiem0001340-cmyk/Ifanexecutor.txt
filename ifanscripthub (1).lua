...
local v466 = vu32:MakeWindow({
    Title = ifanhub (By ifanscript) Blox Fruits",
    SubTitle = "Blox fruit",
    SaveFolder = "Redz | redz lib v5.lua"
})

v466:AddMinimizeButton({
    Button = { Image = "rbxassetid://130729908560425", BackgroundTransparency = 0 },
...
v484:AddDiscordInvite({
    Name = "ifanhub | by ifanscript",
    Description = "Go to TikTok and follow me :)",
    Logo = "rbxassetid://130729908560425",
    Invite = "tiktok: ifanscript or @ifanscript_vn"
})
